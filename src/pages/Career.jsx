  ...
  return (
    <div className="max-w-[full] m-auto">
      ...
      <section className="relative w-full mb-[56px]">
        ...
        <div className="relative z-2 text-white font-semibold max-md:w-full max-md:text-center max-w-[1120px] max-lg:w-[88%] mx-auto max-md:pt-[100px] pt-[50px]">
        ...
        <form action="" className="mt-[100px] max-lg:mt-[30px] max-md:mt-[20px]">
          <div className="relative z-2 max-md:w-[75%] w-[950px] max-lg:w-[80%] mx-auto  flex flex-wrap justify-between">
            <div className="w-[43%] max-md:w-[45%]">
              <select name="" id="" className="px-2 max-md:px-0 h-[50px] max-md:h-[30px] max-lg:mb-4 max-lg:border-b-2 max-lg:rounded-none rounded-md w-full mb-1 max-lg:bg-transparent focus:outline-none max-lg:text-white">
                <option value="" className="max-lg:text-black">All Cities</option>
                <option value="kathmandu" className="max-lg:text-black">Kathmandu</option>
                <option value="Bhaktapur" className="max-lg:text-black">Bhaktapur</option>
                <option value="Lalitpur" className="max-lg:text-black">Lalitpur</option>
                <option value="Biratnagar" className="max-lg:text-black">Biratnagar</option>
                <option value="Pokhara" className="max-lg:text-black">Pokhara</option>
                <option value="Bharatpur" className="max-lg:text-black">Bharatpur</option>
                <option value="Birgunj" className="max-lg:text-black">Birgunj</option>
                <option value="Damak" className="max-lg:text-black">Damak</option>
                <option value="Ithari" className="max-lg:text-black">Ithari</option>
                <option value="Dharan" className="max-lg:text-black">Dharan</option>
              </select>
              ...
              <div className="flex justify-end ">
                ...
                <Link to="/city" className="p-2 hidden max-lg:block text-xs rounded-md bg-[#8b181b] font-bold text-white cursor-pointer hover:bg-[#b02b2f] transition duration-300 ease-in-out">Browse Cities</Link>
              </div>
            </div>
            <div className="w-[43%] max-md:w-[50%]">
              <select name="" id="" className="px-2 max-md:px-0 h-[50px] max-md:h-[30px] max-lg:mb-4 max-lg:border-b-2 max-lg:rounded-none rounded-md w-full mb-1 max-lg:bg-transparent focus:outline-none max-lg:text-white">
                <option value="" className="max-lg:text-black">All Professions</option>
                <option value="UI/UX Designer" className="max-lg:text-black">UI/UX Designer</option>
                <option value="Web Developer" className="max-lg:text-black">Web Developer</option>
                <option value="Mern Stack Developer" className="max-lg:text-black">Mern Stack</option>
                <option value="Flutter Developer" className="max-lg:text-black">Flutter Developer</option>
                <option value="React Native" className="max-lg:text-black">React Native</option>
              </select>
              ...
              <div className="flex justify-start">
                ...
                <Link to="/services" className="p-2 hidden max-lg:block rounded-md bg-[#8b181b] text-xs font-bold text-white hover:bg-[#b02b2f] transition duration-300 ease-in-out">Browse  Professions</Link>
              </div>
            </div>
      ...
      <form className="mb-[56px] flex flex-wrap gap-6 max-w-[1120px] mx-auto max-md:w-[89%] max-lg:w-[88%] max-md:gap-2">
        <input type="text" name="" id="" placeholder="First Name" className="focus:outline-none rounded-md border border-[#C5C5C5] p-3 w-56 max-md:w-full max-lg:w-[48%]" />
        <input type="text" name="" id="" placeholder="Last Name" className="focus:outline-none rounded-md border border-[#C5C5C5] p-3 w-56 max-md:w-full max-lg:w-[48%]" />
        <div className="flex gap-2 border border-[#C5C5C5] items-center px-2 py-3 w-96 max-lg:w-[25rem] rounded-md max-md:w-full">
        ...
        <button type="submit" className="flex gap-2 px-4 py-3 bg-[#8b181b] hover:bg-[#b02b2f] transition duration-300 ease-in-out text-white font-bold max-md:justify-center items-center rounded-md max-md:w-full max-lg:w-[15rem]"><MdOutlinePhoneCallback className="text-[24px]" />Request Callback</button>
      </form>
      ...
      <section className="max-md:w-[89%] max-lg:w-[88%] max-w-[1140px] mx-auto mb-[56px]">
        ...
        <div className=" grid lg:grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 mt-[3rem] max-lg:mt-[1.5rem] gap-4">
          {topProfiles.map((item) => (
            <div className="flex max-lg:block items-center gap-4 w-auto rounded-md max-lg:w-auto h-auto  max-lg:py-2 " key={item.name}>
              <div className="">
                <img src={item.image} alt={item.name} className=" max-lg:w-auto max-lg:h-auto mx-auto" />
              </div>
              <div className="w-[175px] max-lg:w-[100%] max-lg:text-center">
