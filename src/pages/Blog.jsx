...
function Blog() {
  let post1= [
    { id: "1", img: "src/assets/image/1.jpg", title: "How much does a website development cost?", description: "Sharing of right agriculture knowledge and technology to the growers at right time motivates them to improve their crop productivity...", link: "/content/1" },
  ]
  let post2 = [
    { id: "2", img: "src/assets/image/2.jpg", title: "What is corporate business Email?", description: "In the heart of the Himalayas, where lush landscapes and fertile soil meet, Nepal is increasingly embracing organic farming. As a country where agriculture plays a pivotal role in the economy, the shift towards organic practices offers a refreshing solution for both farmers and consumers..." },
  ]
  let post3 = [
    { id: "3", img: "src/assets/image/3.jpg", title: "What is IT Audit ?", description: "Agriculture is the backbone of many economies worldwide, and Nepal is no exception. The country’s vast farming community..." },
    
    { id: "4", img: "src/assets/image/4.jpg", title: "How to keep data safe from Ransomware Attacks?", description: "Water is one of the most critical resources for farming in Nepal, especially as climate change and erratic rainfall patterns continue to...." }, 
  ]
  let post4 = [
    { id: "5", img: "src/assets/image/5.jpg", title: "What is DataBanking?", description: "Agriculture has been the backbone of Nepal’s economy for centuries. However, traditional farming methods, while effective in the past, have often been inefficient..." },

    { id: "6", img: "src/assets/image/6.jpg", title: "The rise of Ecommerce ", description: "Agriculture is a vital part of Nepal’s economy, but farmers in the country face numerous challenges, including unpredictable weather, limited resources and traditional farming practices.." },

    { id: "7", img: "src/assets/image/7.jpg", title: "Digital Transformation for Economic Growth", description: "Livestock farming is a cornerstone of Nepal’s agricultural economy, with dairy and poultry farming playing a significant role in providing nutrition.." },
  ]
  let post5 = [
    { id: "8", img: "src/assets/image/8.jpg", title: "IT Consulting & Solutions", description: "Agriculture remains the backbone of Nepal’s economy, with the majority of the population relying on farming for their livelihood. Recognizing this,..." },

    { id: "9", img: "src/assets/image/9.jpg", title: "Why Your Business in Nepal Needs IT Consulting: A 2025 Perspective", description: "Climate change is one of the biggest challenges facing agriculture today. Rising temperatures, unpredictable rainfall, and extreme weather events are making..." },
  ]
  let post6 = [
    { id: "10", img: "src/assets/image/10.jpg", title: "How IT Consulting Can Reduce Costs and Improve Efficiency for SMEs in Nepal", description: "Selecting the right crops is crucial for successful farming, especially in a country like Nepal, where diverse climates and terrains influence agricultural productivity..." },

    { id: "11", img: "src/assets/image/11.jpg", title: "Custom Software vs Off-the-Shelf: What’s Best for Nepali Businesses?", description: "For small farmers in Nepal, harvesting crops is only half the battle. Without proper post-harvest management and storage solutions, a significant portion of produce.." },
  ]
  let post7 = [
    { id: "12", img: "src/assets/image/12.jpg", title: "A Beginner’s Guide to Choosing the Right IT Consultant in Kathmandu", description: "Organic farming is gaining popularity in Nepal as consumers become more conscious of their health and the environment..." },

    { id: "13", img: "src/assets/image/13.jpg", title: "Digital Transformation in Nepal: Trends, Challenges & Opportunities", description: "For Nepalese farmers, maximizing crop yields is key to improving livelihoods and ensuring food security. With challenges like unpredictable weather..." },

    { id: "14", img: "src/assets/image/14.jpg", title: "How Nepali Businesses Can Embrace Cloud Computing Safely and Efficiently", description: "Farming isn’t just about growing crops, it’s a business that requires smart decision-making to ensure profitability..." },

    { id: "15", img: "src/assets/image/15.jpg", title: "Top 5 Technologies Reshaping Business in Nepal (AI, Cloud, Automation, etc.)", description: "Agriculture has long been the backbone of Nepal’s economy, but in recent years, fewer young people are choosing farming as a career..." },
  ]

  return (
    <>
      <section className="blog bg-[#f9f9f9]">
        <h1 className='text-center text-[45px] font-bold text-[#4b4b4b] py-10'>Blog</h1>
        <hr />
        {/* Blog_1 */}
          ...
          <div className="blog-contents">
            {post3.slice(0, 2).map((d) => (
              <div className="blog-content max-w-[590px] h-[300px] lg:h-[242px] border gap-y-40 overflow-hidden rounded-xl my-6 flex text-gray-600">
                ...
                <div className="image">
                  <img className='hidden lg:block md:block sm:block w-[300px] h-[260px] object-cover rounded-e-xl' src={d.img} alt="" />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto max-w-[1200px] flex flex-col md:flex-row items-center justify-between gap-y-6 gap-4 px-4 lg:px-0">
          {post5.slice(0, 2).map((f) => (
            <div className="blog-content max-w-[590px] h-[300px] lg:h-[240px] border overflow-hidden rounded-xl flex text-gray-600 mb-4">
              ...
              <div className="image">
                <img className='hidden lg:block md:block sm:block w-[300px] h-[238px] object-cover rounded-e-xl' src={f.img} alt="" />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="container mx-auto max-w-[1200px] flex flex-col md:flex-row justify-between items-center gap-y-6 gap-4 px-4 lg:px-0">
          {post6.slice(0, 2).map((g) => (
            <div className="blog-content max-w-[590px] h-[300px] lg:h-[240px] border rounded-xl overflow-hidden flex text-gray-600 mb-6">
              ...
              <div className="image">
                <img className='hidden lg:block md:block sm:block w-[300px]  h-[238px] object-cover rounded-e-xl' src={g.img} alt="" />
              </div>
            </div>
          ))}
        </div>
