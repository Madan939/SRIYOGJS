  ...
  return (
    <>
      ...
      <section className=" w-full  relative">
        <div className="max-w-[1140px] px-[15px] max-md:px-0 mx-auto  max-md:w-[88%] max-lg:w-[88%]">
          <div className=" mx-auto relative px-[10px] container ">
            <div className="absolute left-[50%] top-0 h-full w-1 bg-[#862124] transform -translate-x-1/2 z-0  max-md:translate-x-0 max-lg:left-[11%] max-lg:translate-x-0"></div>
