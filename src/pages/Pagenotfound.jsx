    ...
    <>
      <section className='max-w-[1140px] max-lg:w-[88%] mx-auto flex justify-around items-center  my-[56px]'>
        <div className='lg:w-[45%] max-lg:w-[50%] text-center space-y-6'>
          ...
          <img src="/assets/images/app/mobile.png" alt="mobile" className='h-64 hidden max-md:block mx-auto' />
          ...
          <div className='grid grid-cols-2 gap-4 position-center'>
            <Link to="https://bit.ly/sriyog" target='_blank'><img src="/assets/images/app/google.png" alt="google" /></Link>
            <Link to="https://bit.ly/sriyogios" target='_blank'><img src="/assets/images/app/apple.png" alt="apple" /></Link>
          </div>
        </div>
