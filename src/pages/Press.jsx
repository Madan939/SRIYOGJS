      ...
      <div className=" bg-white p-5  text-justify max-w-[1140px] max-md:w-[89%] max-lg:w-[88%]">
        <div className="p-3">
          ...
          <div className="text-justify">
            <i>बि. स. १९ जेठ २०८१, तदनुसार ई. स. १ जुन २०२४, शनिबार, बिराटनगर</i>
            <br></br>
            <br></br>
            ...
            <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">प्ले स्टोरमा एक लाख भन्दा बढी डाउनलोड भएको यो एपलाई एप्पल स्टोरमा सन २०२४ सेप्टेम्बर सम्ममा ल्याउने संस्थाको योजना रहेको छ । बिराटनगरमा बनेको एपले अर्बन कम्पनीको रिभर्स मोडेलमा ईन्डियामा लन्च गर्ने सम्पूर्ण तयारी गरी सकेको र सोही रिभर्स मोडेलमा सर्भिस मार्केटप्लेसका कमी कमजोरीलाई मध्यनजर गरि प्रोफेसनल मार्केटप्लेसमा बदल्दै आम्दानीको १००% काम गर्ने व्यक्तिकै हुनुपर्छ भन्ने लक्ष्यका साथ <a href="https://en.wikipedia.org/wiki/Disintermediation" className="text-[#007bff] hover:text-blue-900 hover:underline">No Middleman Concept</a> मा संस्था कार्यरत छ ।</p>
            <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">एपमा भएको २९,९०० प्रयोगकर्ता साथै “व्यवसायिक शिक्षा तथा तालिम अभिवृद्धि परियोजना (दोस्रो)” र वर्ल्ड बैंकसँग भएको सम्झौताका अन्य ५५ हजार प्राविधिकलाई एउटै एपमा राखी काम गर्ने सहज वातावरणको बिकासका लागि यो एप अग्रसर रहेको उप्रेतीको भनाइ छ । पहिला भएको विवरण र नयाँ विवरण भेरिफाइ गर्न अब हरेक प्राविधिकको आफ्नै संस्थागत इमेल @sriyog.com रहने र उक्त ईमेल रसियन टेक्नोलोजीमा आधारित येण्डेक्सबाट संचालित हुनेछ ।</p>
            ...
            <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">उद्योग संगठन मोरङ अन्तर्गत Chamber of Industries Morang को “<a href="https://www.cim.org.np/program-project/cim-startup-and-innovation-program#:~:text=Startup%20and%20Innovation%20program%20is,ideas%20into%20sustainable%20startup%20enterprises." className="text-[#007bff] hover:text-blue-900 hover:underline">CIM Startup and Innovation Program </a>” बाट नर्चरिङ्ग हुँदै गरेको यो एप हिमालयन रोड बिराटनगर, नेपाल एस बिआइ बैंक लिमिटेडको माथि प्रकाश ईन्फोशिस प्रा.लि. को इन्क्युबेसन सेन्टरबाट सञ्चालन भइरहेको छ ।</p>
            <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">एप खुल्ला डिजिटल प्लेटफर्मको अवधारणाबाट चलि रहेको र सेवाग्राहीहरुलाई अझ परिष्कृत सेवा दिने उद्धेश्यले प्रोफेसनल मेम्बरहरुलाई भेरिफाई गरी दक्ष प्राविधिकहरुलाई मात्र सूचीकृत गर्ने संस्थाको योजना रहेको छ ।</p>
            <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">SRIYOG मा मेम्बर हुनका लागि आफुले दिने सेवा, स्थान, सम्पर्क नम्बर आदि राखी दर्ता गरेकै आधारमा काम प्राप्त गर्न सकिने, साथै मेम्बर बनिसके पछि प्राविधिकहरुको डिजिटल प्रोफाइल, संस्थाकै इमेल आइडी बन्ने र उक्त विवरण एक वर्ष सम्म SRIYOG को एपमा रहने र त्यसलाई संस्थाले बार्षिक न्यूनतम शुल्क रु १,९९९ मात्र लिएर बेरोजगारीको समस्यालाई अवसरमा परिणत गर्ने गरि अब झन ससक्त रुपमा अघि बढी सकेको छ ।</p>
            <p className="font-normal leading-relaxed text-[#333] text-{18px] mb-4">सेवा लिने र दिने व्यक्तिहरुको बीचमा भएको समझदारी बिशुद्द रुपमा दुवै व्यक्तिको भई तेस्रो प्रदायकको कुनै कमिसन नहोस भन्ने एपको चाहना हो ।</p>
            {/* <p className="font-normal leading-relaxed text-[#333] text-[18px] mb-4">
              App Download Link :
              <a href="www.bit.ly/sriyog" className="text-[#007bff] text-[18px] hover:underline hover:text-blue-900">Download</a>
              <br></br>
              Website :
